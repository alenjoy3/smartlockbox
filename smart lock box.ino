...
<html>
  ...
  <body class="noselect" align="center" style="background-color:#fff1cc">
    ...
    <table id="mainTable" style="width:400px;margin:auto;table-layout:fixed" CELLSPACING=10>
      ...
      <tr/><tr/>
      <tr>
        <td style="text-align:left"><b>lock:</b></td>
        <td colspan=2>
         <div class="slidecontainer">
            <input type="range" min="0" max="90" value="90" class="slider" id="Lock" oninput='sendButtonInput("Lock",value)'>
          </div>
        </td>
      </tr> 
      <tr/><tr/>            
    ...
    <script>
      ...
      function initServoInputWebSocket() 
      {
        ...
        {
          var panButton = document.getElementById("Lock");
          sendButtonInput("Lock", panButton.value);
...
void setUpPinModes()
{
  ...
  dummyServo3.attach(DUMMY_SERVO3_PIN);  
